...
def _runtime_paths_module():
    module_name = "_test_system_rag_runtime_paths"
...
def test_absolute_env_path_uses_override_and_fallback(tmp_path):
    absolute_env_path = _runtime_paths_module().absolute_env_path
...
def test_absolute_env_path_rejects_relative_override(tmp_path):
    absolute_env_path = _runtime_paths_module().absolute_env_path
